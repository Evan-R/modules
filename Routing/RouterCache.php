...
/*
 * This File is part of the Selene\Package\Framework\Routing package
 *
...
use \Selene\Module\Config\Loader\LoaderInterface as Loader;
use \Selene\Module\Routing\Cache\StorageInterface as Store;
...
class RouterCache implements LoaderListener
{
     ...
     * @param boolean $debug
     */
    public function __construct($resources, $manifest, Store $storage, Loader $loader, $debug = false)
    {
        $this->debug    = $debug;
        $this->loader   = $loader;
